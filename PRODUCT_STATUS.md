...
Last updated: 2026-06-18 (Fix crítico: React hydration errors + deduplication en HumanChatPanel)
...
| **Human-to-human chat (Panel 1)** | ✅ Closed | OE B.4 — HumanChatPanel with Realtime, day markers, selection support (commit 5654c51, migrations 037+038 pending). Fix crítico 2026-06-18: React hydration errors resueltos (commits 829abdd + 7a3a3f7) — mensajes ahora aparecen sin necesidad de F5. |
