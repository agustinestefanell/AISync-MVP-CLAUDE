...
| Review & Forward en isolated teams | ⏳ Pending | Manager panel en isolated teams muestra Worker 1/Worker 2 como destinatarios de Review & Forward (workers ocultos pero existentes en DB), no incluye al usuario humano de la conexión como destinatario válido — diagnóstico pendiente. |
