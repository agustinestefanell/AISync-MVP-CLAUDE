...
- /start visual redesign: ✅ Closed — BLOQUE 1.1 implementado 2026-06-16. ChatFirstClient.tsx reescrito con colorimetría exacta, layout 3 columnas, SVG inline (robot+checklist+shield), badge "AI" púrpura, CTA "Start governed work →", copy exacto, step 2 "AISync structures your first work path." Bundle: 3.69kB → 5.09kB (+1.4kB). Ajustes visuales aplicados: IBM Plex Sans, íconos fill color, robot hero mejorado (280x220px con órbita+checkmarks), mini-cards step 2/3 con path visual y colaboración. Bundle final: 5.61kB (+520 bytes).
