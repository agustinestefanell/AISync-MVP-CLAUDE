...
| Review & Forward en isolated teams | ✅ Closed | Manager panel en isolated teams ahora ofrece como target de Review & Forward al usuario humano del otro lado de la conexión (email de la contraparte). El dropdown no muestra Worker 1/Worker 2 (ocultos en UX). Envío usa `/api/human-chat` existente. Mensaje aparece via Realtime. Audit log con metadata extendida. Teams normales sin cambios. Commit pending 2026-06-24. |
