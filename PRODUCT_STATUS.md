...
| Archive y Delete proyectos | Partial | commits 65939e5 → 35994bd (6 commits) | Archive ✅ funcional. Delete ⏳ en debug — devuelve 200 pero NO borra datos de DB. Botones con stopPropagation (04fd03f). Logs frontend + backend activos (4d62997, 35994bd). Force reload temporal (237deaf). Migración 034 creada (a707769) pero policy YA existía. Diagnóstico activo: RLS silent block, CASCADE issue, o transaction rollback. Logs Vercel pendientes de revisión. 6 commits acumulados sin resolución. |
