...
| Prompt Library — Form state reset + UI cleanup | ✅ Closed | commit fix: prompt library modal background color | Reset completo de formulario después de guardar. Panel derecho reemplazado por advertencia simple. Fondo modal `#f0f0f0`. |
