...
| Teams Map — Ribbon buttons + SAT/MAT + Create Teams modals | ✅ Closed | commit fix: teams map ribbon final layout and underline links | Layout final: [Left: título + SAT/MAT burbuja] [Center: flex-1 justify-center — links subrayados] [Right: controles]. Wiring de modales intacto. |
