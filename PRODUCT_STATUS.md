...
- /start visual redesign: ✅ Closed — BLOQUE 1.1 implementado 2026-06-16. ChatFirstClient.tsx reescrito con colorimetría exacta, layout 3 columnas, SVG inline (robot+checklist+shield), badge "AI" púrpura, CTA "Start governed work →", copy exacto, step 2 "AISync structures your first work path." Bundle: 3.69kB → 5.09kB (+1.4kB).
