...
| Teams Map — Ribbon buttons + SAT/MAT + Create Teams modals | ✅ Closed | commit fix: teams map ribbon links out of bubble and grouped | Layout final: [Left: título + burbuja SAT/MAT (texto plano) + dos links subrayados agrupados] [Right: controles]. Burbuja sin botón. Wiring de modales intacto. |
