        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          <div className="grid grid-cols-2 gap-x-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              {agents.length > 0 && (
                <div>
                  <label className="block text-xs font-medium text-gray-400 mb-2">Agents</label>
                  <div className="space-y-2">
                    {agents.map((a, i) => {
                      const local = isLocal(a.provider)
                      const cloud = isCloud(a.provider)
                      return (
                        <div key={a.id} className="bg-gray-800/60 border border-gray-700 rounded-lg px-3 py-2.5 space-y-2">
